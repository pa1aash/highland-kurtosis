...
The target material was PLA (polylactic acid, chemical formula $(\text{C}_3\text{H}_4\text{O}_2)_n$, density $\rho=\SI{1.24}{g/cm^3}$, radiation length $X_0=\SI{315}{mm}$ ($\SI{43}{g/cm^2}$) as computed by Geant4 from the elemental composition.  The target dimensions were $20\times 20\times\SI{10}{mm^3}$ ($20\times\SI{20}{mm^2}$ transverse, $\SI{10}{mm}$ along the beam).  The world volume was a $200\times 200\times\SI{200}{mm^3}$ air box.
